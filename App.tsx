...
const Navbar = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 flex justify-between items-center bg-[#558b2f]/90 backdrop-blur-lg shadow-lg">
    ...
    <a href={PUMPFUN_URL} target="_blank" className="bg-white text-[#558b2f] px-6 py-2 rounded-full font-meme text-xl hover:shadow-xl transition-all hover:-translate-y-1 border-2 border-[#558b2f]">
      BUY NOW
    </a>
  </nav>
);
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden bg-[#558b2f]">
      <Navbar />
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            ...
            <div className="flex gap-4">
                <a 
                  ...
                  target="_blank" 
                  className="p-4 bg-white text-[#558b2f] rounded-full hover:scale-110 transition-transform shadow-lg hover:shadow-white/20"
                >
                  <XLogo size={32} />
                </a>
                <a 
                  href={PUMPFUN_URL} 
                  target="_blank" 
                  className="px-8 py-4 bg-white text-[#558b2f] rounded-full hover:scale-110 transition-transform shadow-lg hover:shadow-white/20 font-meme text-2xl"
                >
                  PUMP.FUN
                </a>
            </div>
      ...
      {/* About Section */}
      <section id="about" className="py-32 px-6 bg-white text-[#558b2f] relative z-10 rounded-t-[3rem] -mt-10 shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid gap-12 text-left">
            <motion.div 
              ...
              className="bg-[#558b2f]/5 p-8 rounded-3xl border-l-8 border-[#558b2f] hover:bg-[#558b2f]/10 transition-colors"
            >
              <h3 className="text-4xl font-meme mb-4 text-[#558b2f]">THE NARRATIVE</h3>
            ...
            <motion.div 
              whileInView={{ x: 0, opacity: 1 }}
              initial={{ x: 50, opacity: 0 }}
              className="bg-[#558b2f]/5 p-8 rounded-3xl border-r-8 border-[#558b2f] hover:bg-[#558b2f]/10 transition-colors text-right"
            >
              <h3 className="text-4xl font-meme mb-4 text-[#558b2f]">COMMUNITY RESILIENCE</h3>
              <p className="text-xl md:text-2xl leading-relaxed font-medium text-gray-700">
            ...
            <motion.div 
              ...
              className="bg-[#558b2f]/5 p-8 rounded-3xl border-l-8 border-[#558b2f] hover:bg-[#558b2f]/10 transition-colors"
            >
              <h3 className="text-4xl font-meme mb-4 text-[#558b2f]">PROVEN LEGACY</h3>
              <p className="text-xl md:text-2xl leading-relaxed font-medium text-gray-700">
                Backed by the same developer responsible for $FKH's notable run (which scaled to multi-million market cap levels previously) and the original CTO lead which took SED to 2 million, $SED inherits valuable institutional knowledge of Solana's viral mechanics. Experience in executing high-visibility launches adds a layer of strategic depth to the project's trajectory.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* Memes Section */}
      <section id="memes" className="py-32 px-6 bg-[#222] text-white relative z-10 border-t-8 border-[#558b2f]">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            className="text-6xl md:text-8xl font-meme text-center mb-20 text-[#558b2f] text-outline drop-shadow-lg"
          >
            MEME GALLERY
          </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {MEME_IMAGES.map((src, index) => (
              <motion.div
                ...
                className="rounded-2xl overflow-hidden border-4 border-[#558b2f]/50 shadow-2xl bg-black"
              >
                <img 
                  src={src} 
      ...
      {/* How to Buy Section */}
      <section id="buy" className="py-32 px-6 bg-[#558b2f] text-white relative z-10 border-t-8 border-white/20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-20 text-center">
            <a 
              href={PUMPFUN_URL}
              target="_blank"
              className="inline-block bg-white text-[#558b2f] font-meme text-3xl px-12 py-6 rounded-full hover:scale-105 transition-all shadow-xl hover:shadow-2xl hover:bg-gray-100"
            >
              🚀 VIEW ON PUMP.FUN 🚀
            </a>
          </div>
      ...
      {/* Chart Section */}
      <section id="chart" className="py-32 px-6 bg-white text-[#558b2f] relative z-10 rounded-t-[3rem] -mt-10 shadow-[0_-20px_40px_rgba(0,0,0,0.1)]">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-6xl md:text-8xl font-meme text-center mb-16 text-outline">STATS</h2>
          <div className="w-full h-[600px] rounded-[2.5rem] overflow-hidden border-8 border-[#558b2f] shadow-2xl">
            <iframe 
              width="100%" 
              height="100%" 
      ...
      {/* Footer */}
      <footer className="py-20 px-6 bg-[#33691e] text-white text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-center gap-6 mb-16">
            <a href={SED_TWITTER_URL} target="_blank" className="bg-white text-[#558b2f] p-4 rounded-full hover:scale-125 transition-transform shadow-lg">
              <XLogo size={28} />
            </a>
            <a href={PUMPFUN_URL} target="_blank" className="bg-white text-[#558b2f] px-8 py-4 rounded-full font-meme text-xl hover:scale-110 transition-transform shadow-lg">
              PUMP.FUN
            </a>
          </div>
          
          <div className="text-xl font-meme opacity-50 tracking-widest pt-10 border-t border-white/10">
            &copy; 2026 SMOKING EAGLE DOG - THE HYBRID LEGEND
          </div>
        </div>
      </footer>
    </div>
